export function Judge({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 180 150" width={200} height={170} className={className} aria-hidden="true" focusable="false">
      ...
      {/* gavel (handle bottom meets the hand) — taps on hover */}
      <g className="lego-tap">
      ...
      {/* verdict tiles */}
      <g className="lego-twinkle"><rect x="116" y="100" width="22" height="22" rx="4" fill="#2f9e44"/><path d="M121 111 l5 5 8 -10" stroke="#fff" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round"/></g>
