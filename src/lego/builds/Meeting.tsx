export function Meeting({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 220 200" width={220} height={200} className={className} aria-hidden="true" focusable="false">
      ...
      <g className="lego-grow" fill="#006cb7"><rect x="28" y="56" width="9" height="12" rx="1.5"/><rect x="41" y="48" width="9" height="20" rx="1.5"/><rect x="54" y="52" width="9" height="16" rx="1.5"/><rect x="67" y="42" width="9" height="26" rx="1.5"/></g>
      ...
      <g><rect x="112" y="100" width="22" height="20" rx="7" fill="#ffd21f"/><circle cx="119" cy="111" r="1.8" fill="#1a1a1a"/><circle cx="127" cy="111" r="1.8" fill="#1a1a1a"/><path d="M110 122 L136 122 L140 150 L106 150 Z" fill="#2f9e44"/>
        {/* checked-in badge */}
        <g className="lego-twinkle"><circle cx="138" cy="100" r="9" fill="#2f9e44" stroke="#fff" strokeWidth="1.5"/><path d="M133 100 l3.5 3.5 6 -7" stroke="#fff" strokeWidth="2.4" fill="none" strokeLinecap="round" strokeLinejoin="round"/></g></g>
      {/* three */}
